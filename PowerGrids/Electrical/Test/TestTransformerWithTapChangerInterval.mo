...
model TestTransformerWithTapChangerInterval
  ...
  PowerGrids.Electrical.Branches.TransformerWithTapChangerInterval transfo(B = 0, G = 0, K = {2, 3, 4, 5, 6}, Ntap = 5, R = 1, SNom = 1e+06, UMax = 4000, UMin = 2000, UNomA = 1000, UNomB = 1000, X = 1, actionSel = PowerGrids.Electrical.Branches.BaseClasses.TapChangerPhaseShifterLogicCommon.ActionType.direct, portVariablesPu = true, t1st = 1, tNext = 0.1, tapStart = 2) annotation(
...
equation
  ...
  connect(transfo.terminalB, busLoad.terminal) annotation(
    Line(points = {{10, 0}, {30, 0}}));
  connect(infiniteBus.terminal, transfo.terminalA) annotation(

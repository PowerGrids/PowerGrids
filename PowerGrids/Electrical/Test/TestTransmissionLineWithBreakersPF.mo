...
model TestTransmissionLineWithBreakersPF
  ...
  PowerGrids.Electrical.Loads.LoadPQVoltageDependence LoadAcBc(PRefConst = 1e+07, QRefConst = 1000000, SNom = 1e+07, UNom = 10000, URef = 10000, alpha = 0, beta = 0, portVariablesPhases = true) annotation(
  ...
  PowerGrids.Electrical.Loads.LoadPQVoltageDependence LoadAoBc(PRefConst = 1e+07, QRefConst = 1000000, SNom = 1e+07, UNom = 10000, URef = 10000, alpha = 0, beta = 0, portVariablesPhases = true) annotation(
  ...
  PowerGrids.Electrical.Loads.LoadPQVoltageDependence LoadAcBo(PRefConst = 1e+07, QRefConst = 1000000, SNom = 1e+07, UNom = 10000, URef = 10000, alpha = 0, beta = 0, portVariablesPhases = true) annotation(
  ...
  PowerGrids.Electrical.Loads.LoadPQVoltageDependence LoadAoBo(PRefConst = 1e+07, QRefConst = 1000000, SNom = 1e+07, UNom = 10000, URef = 10000, alpha = 0, beta = 0, portVariablesPhases = true) annotation(

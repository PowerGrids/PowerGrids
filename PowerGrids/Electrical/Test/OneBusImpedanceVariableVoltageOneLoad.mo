...
model OneBusImpedanceVariableVoltageOneLoad
  ...
  PowerGrids.Electrical.Buses.InfiniteBusVariableVoltage bus1(PStart = -1e+07, R = 0.04, SNom = 1e+08, UNom = 10000, UFixed = 10e3, X = 0.4, generatorConvention = true, useUPhaseIn = true, useUIn = true) annotation(

...
model OneBusTransmissionLineOneLoad
  ...
  PowerGrids.Electrical.Loads.LoadPQVoltageDependence loadPQ(PRefConst = 1e+07, QRefConst = 0, SNom = 10000000, alpha = 0, beta = 0, portVariablesPhases = true, URef = 10000) annotation(

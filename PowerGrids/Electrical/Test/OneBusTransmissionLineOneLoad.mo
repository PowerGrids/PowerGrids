...
model OneBusTransmissionLineOneLoad
  ...
  PowerGrids.Electrical.Loads.LoadPQVoltageDependence loadPQ(PRefConst = 1e+07, QRefConst = 0, SNom (displayUnit = "V.A")= 10000000, alpha = 0, beta = 0, portVariablesPhases = true, URef = 10000, UStart(displayUnit = "V")) annotation(
...
equation
  ...
  connect(loadPQ.terminalAC, LoadBus.terminalAC) annotation(

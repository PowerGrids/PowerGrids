...
model SynchronousMachine4WindingsPowerSwing
  ...
  PowerGrids.Electrical.Loads.LoadPQVoltageDependenceInputs load(PStart (displayUnit = "W")= 4.95e+08, QStart (displayUnit = "var")= 2.5e+08, SRef = 5.5e+08, portVariablesPhases = true, URef = 24000, UStart(displayUnit = "V")) annotation(

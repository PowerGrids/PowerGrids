...
model LoadImpedancePQ "Test case for LoadImpedancePQ"
  ...
  PowerGrids.Electrical.Loads.LoadImpedancePQ load1(PRef = 8e+07, PRefConst = 8e+07, QRef = 4e+07, QRefConst = 4e+07, SNom = 1e+08, UNom = 380000, URef = 400000, portVariablesPhases = true) annotation(
    Placement(visible = true, transformation(origin = {-70, -20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  PowerGrids.Electrical.Loads.LoadImpedancePQ load2(PRef = 8e+07 + (if time >= 1 then 1e7 else 0), PRefConst = 8e+07, QRef = 4e+7 + (if time >= 2 then 5e6 else 0), QRefConst = 4e+07, SNom = 1e+08, UNom = 380000, URef = 400000, portVariablesPhases = true) annotation(
    Placement(visible = true, transformation(origin = {0, -20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  PowerGrids.Electrical.Loads.LoadImpedancePQInputs load3(SNom = 5e+08, SRef = 5e+08, UNom = 380000, URef = 400000, portVariablesPhases = true, PRefConst = 80000000, QRefConst = 40000000)  annotation(
    Placement(visible = true, transformation(origin = {70, -20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  Modelica.Blocks.Sources.Step QRef(height = 5e6, offset = 40e6, startTime = 2)  annotation(

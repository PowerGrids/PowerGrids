...
model SynchronousMachine4WindingsExact
  ...
  PowerGrids.Electrical.Buses.InfiniteBus bus(SNom = 5.5e+08, UNom = 24000, UStart = 24000, X = 0, portVariablesPhases = true) annotation(
  ...
  inner PowerGrids.Electrical.System systemPowerGrids(fNom = 60, final computePF = false) annotation(

...
model SynchronousMachine4WindingsPF3
  ...
  PowerFlow.TransformerFixedRatioPF TGEN21(X = 0.4, UNomA = 24000, SNom = 5e8) annotation(
  ...
  Branches.TransformerFixedRatio TGEN22(X = 0.4, UNomA = 24000, SNom = 5e8) annotation(

...
model TestEquivalentGrid "Test case EquivalentGrid model"
  ...
  Buses.EquivalentGrid equivalentGrid(R_X = 1 / 10, SNom = 5e+08, SSC = (2.5e+09)/1.1, UNom = 380000, URef = 1.050 * 380e3, portVariablesPhases = true, portVariablesPu = true)  annotation(
...
equation
  ...
  connect(ground.terminalAC, equivalentLine.terminalAC_a) annotation(

...
model OneBusOneLoad
  ...
  PowerGrids.Electrical.Loads.LoadPQVoltageDependence loadPQ(PRefConst = 1e+07, QRefConst = 0, SNom (displayUnit = "V.A")= 1e+07, portVariablesPhases = true, URef = 10000, UStart(displayUnit = "V")) annotation(

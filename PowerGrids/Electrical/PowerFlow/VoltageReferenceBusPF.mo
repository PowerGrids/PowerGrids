...
equation
  ...
  // setVoltage is set to false, so that this component provides the two equations to set
  // the reference voltage and phase to the network instead of the slack bus.

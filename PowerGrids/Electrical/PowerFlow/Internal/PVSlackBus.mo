...
model PVSlackBus
  ...
  final Types.ActivePower PSlack = port.P if isRefNodeEPF "slack active power leaving system through bus";
  final Types.ReactivePower QSlack = port.Q if isRefNodeEPF "slack reactive power leaving system through bus";

...
equation
  ...
  connect(TGEN.terminalB, NTHV.terminal) annotation (
    Line(points = {{30, -24}, {48, -24}}));
  connect(NTHV.terminal, GRIDL.terminal) annotation (
    Line(points = {{48, -24}, {68, -24}, {68, -44}}));
  connect(GEN.PPu, PSS.Vsi2Pu) annotation (
    Line(points={{-16,-2},{0,-2},{0,56},{-126,56},{-126,-6},{-108.2,-6}},            color = {0, 0, 127}));
  connect(GEN.VPu, AVR.VcPu) annotation (
    Line(points = {{-16, -6}, {10, -6}, {10, 64}, {-134, 64}, {-134, -14}, {-72, -14}}, color = {0, 0, 127}));
  ...
  connect(GEN.omegaPu, PSS.Vsi1Pu) annotation (
    Line(points = {{-16, 2}, {-8, 2}, {-8, 48}, {-120, 48}, {-120, 6}, {-108, 6}}, color = {0, 0, 127}));
  ...
  connect(NTLV.terminal, TGEN.terminalA) annotation (
    Line(points = {{-2, -24}, {10, -24}}));
  connect(GEN.terminal, NTLV.terminal) annotation (
    Line(points = {{-26, 0}, {-26, -24}, {-2, -24}}));
  annotation (
    Diagram(coordinateSystem(extent={{-140,-60},{100,80}})),

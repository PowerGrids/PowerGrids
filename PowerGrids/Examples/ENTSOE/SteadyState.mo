...
equation
  ...
  connect(GRID.terminal, NTHV.terminal) annotation(
    Line(points = {{80, -28}, {40, -28}}));
  connect(TGEN.terminalB, NTHV.terminal) annotation(
    Line(points = {{26, -28}, {40, -28}}));
  connect(NTHV.terminal, GRIDL.terminal) annotation(
    Line(points = {{40, -28}, {58, -28}, {58, -42}}));
  connect(GEN.PPu, PSS.Vsi2Pu) annotation(
    Line(points = {{-16, -2}, {-4, -2}, {-4, 54}, {-122, 54}, {-122, -6}, {-108, -6}}, color = {0, 0, 127}));
  connect(GEN.VPu, AVR.VcPu) annotation(
    Line(points = {{-16, -6}, {0, -6}, {0, 58}, {-126, 58}, {-126, -14}, {-72, -14}}, color = {0, 0, 127}));
  ...
  connect(GEN.omegaPu, PSS.Vsi1Pu) annotation(
    Line(points = {{-16, 2}, {-8, 2}, {-8, 48}, {-118, 48}, {-118, 6}, {-108, 6}}, color = {0, 0, 127}));
  ...
  connect(NTLV.terminal, TGEN.terminalA) annotation(
    Line(points = {{-6, -28}, {6, -28}}));
  connect(GEN.terminal, NTLV.terminal) annotation(
    Line(points = {{-26, 0}, {-26, -28}, {-6, -28}}));
  annotation(
    Diagram(coordinateSystem(extent = {{-140, 60}, {100, -60}})),

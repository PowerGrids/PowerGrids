...
model SteadyState "Reproduces the basic static power flow, see fig. 3-1 of the report"
  ...
  PowerGrids.Electrical.Buses.Bus NTHV(UNom = 380000, UPhaseStart = 0, UStart = 1.050 * 380e3,portVariablesPhases = true)  annotation(
  ...
  PowerGrids.Electrical.Loads.LoadImpedancePQ GRIDL(PRefConst = 4.75e+08, PStart(displayUnit = "W"), QRefConst = 7.6e+07, SNom = 5e+08, UNom = 380000, URef(displayUnit = "V") = 1.05 * 380e3, UStart(displayUnit = "V"), portVariablesPhases = true)  annotation(
  ...
  Electrical.Buses.EquivalentGrid GRID(R_X = 1 / 10, SNom = 5e+08, SSC = (2.5e+09)/1.1, UNom = 380000, URef = 1.05 * 380e3, portVariablesPhases = true)  annotation(

...
model PowerFlowUinit
  extends Modelica.Icons.Example;
  inner Electrical.System systemPowerGrids annotation(
    Placement(transformation(origin = {50, 40}, extent = {{-10, -10}, {10, 10}})));
  PowerGrids.Electrical.PowerFlow.PVBus GEN(UNom = 21000, SNom = 500000000, P = -475000000, U = 20832)  annotation(
    Placement(transformation(origin = {-24, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));

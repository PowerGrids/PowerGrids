...
model TestLoadPQ
  ...
  PowerGrids.Examples.Tutorial.HowToBuild.Components.LoadPQ LOAD1(PStart = 495000000, QStart = 0, SNom = 1e6, UNom = 1000) annotation(
  ...
  Components.LoadPQ LOAD2(UNom = 1000, SNom = 1e6)  annotation(

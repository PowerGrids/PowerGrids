...
model StaticGridDifferentNominals "Systems operating in steady-state with different nominal values"
  ...
  PowerGrids.Electrical.Branches.TransformerFixedRatio TGEN_2(RccPu = 0.15e-2, SNom = 5e+08, UNomA = 21000, UNomB = 100000, XccPu = 16e-2, rFixed = 419/21) annotation(
  ...
  PowerGrids.Electrical.Branches.TransformerFixedRatio TGEN_3(RccPu = 0.15e-2, SNom = 5e+08, UNomA = 21000, UNomB = 419000, XccPu = 16e-2, rFixed = 419/21) annotation(

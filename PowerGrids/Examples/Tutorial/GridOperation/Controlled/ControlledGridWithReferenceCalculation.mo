...
model ControlledGridWithReferenceCalculation "System under automatic control with automatic computation of set point offsets"
  ...
  PowerGrids.Electrical.Machines.SynchronousMachine4Windings GEN(H = 4, PPF = -4.75e+08, SNom = 5e+08, Tpd0 = 5.143, Tppd0 = 0.042, Tppq0 = 0.083, Tpq0 = 2.16, UNom = 21000, raPu = 0, xdPu = 2, xlPu = 0.15, xpdPu = 0.35, xppdPu = 0.25, xppqPu = 0.3, xpqPu = 0.5, xqPu = 1.8, useExtraInitEquationsPV = true)  annotation(
...
equation
  ...
  connect(PSS.Vsi1Pu, GEN.omegaPu) annotation(
    Line(points = {{-108, 6}, {-120, 6}, {-120, 44}, {-10, 44}, {-10, 3}, {-20, 3}}, color = {0, 0, 127}));
  connect(PSS.Vsi2Pu, GEN.PPu) annotation(
    Line(points = {{-108, -6}, {-124, -6}, {-124, 48}, {-6, 48}, {-6, 5}, {-20, 5}}, color = {0, 0, 127}));

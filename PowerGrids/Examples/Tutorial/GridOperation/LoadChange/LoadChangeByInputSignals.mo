...
model LoadChangeByInputSignals "Load step response specified by input signals"
  ...
  PowerGrids.Electrical.Buses.BusFault NTHV(R = 0.05,SNom = 5e+08, UNom = 380000, UPhaseStart = 0, UStart = 1.050 * 380e3,portVariablesPhases = true, startTime = 1e10, stopTime = 1e10)  annotation (
    Placement(visible = true, transformation(origin={30,4},      extent = {{-10, 10}, {10, -10}}, rotation = 90)));

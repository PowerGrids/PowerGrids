...
model AM1stOrder
  ...
  PowerGrids.Electrical.Machines.AsynchronousMachine1stOrder am1(ExpCm = 2,H = 2, PStart(displayUnit = "MW") = 100000, QStart(displayUnit = "var") = 43595.04412101686, RrPu = 0.00489, RsPu = 0.028, SNom(displayUnit = "V.A") = 0.1e6, UNom(displayUnit = "V") = 20000, UStart(displayUnit = "kV") = 20000, XmPu = 4.236, XrPu = 0.1822, XsPu = 0.01) annotation(

...
model AM3rdOrderNominalReference
  ...
  PowerGrids.Electrical.Machines.AsynchronousMachine3rdOrder am1(H = 2,PStart(displayUnit = "MW") = 10000, QStart(displayUnit = "MVA") = 11878, RrPu = 0.00489, RsPu = 0.028, SNom(displayUnit = "V.A") = 0.05e6, UNom(displayUnit = "V") = 20000, UPhaseStart (displayUnit = "rad") =-0.0044349, UStart(displayUnit = "kV") = 19870.2, LmPu = 4.236, LrPu = 0.1822, LsPu = 0.01) annotation(

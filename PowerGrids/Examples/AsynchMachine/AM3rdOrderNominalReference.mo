...
model AM3rdOrderNominalReference
  ...
  PowerGrids.Electrical.Machines.SynchronousMachine4Windings GEN(H = 4, PStart(displayUnit = "W") = -0.100631e6, QStart(displayUnit = "var") = -49875.4, SNom(displayUnit = "V.A") = 1e6, Tpd0 = 5.143, Tppd0 = 0.042, Tppq0 = 0.083, Tpq0 = 2.16, UNom(displayUnit = "V") = 20000, UPhaseStart = 0, UStart(displayUnit = "V") = 20e3, portVariablesPhases = true, raPu = 0, referenceGenerator = false, xdPu = 2, xlPu = 0.15, xpdPu = 0.35, xppdPu = 0.25, xppqPu = 0.3, xpqPu = 0.5, xqPu = 1.8) annotation(
...
end AM3rdOrderNominalReference;

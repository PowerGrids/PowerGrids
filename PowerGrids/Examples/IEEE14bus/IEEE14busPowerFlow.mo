...
model IEEE14busPowerFlow "Power flow model of the IEEE 14-bus benchmark"
  ...
  PowerGrids.Electrical.PowerFlow.PVBus GEN2(
    ...
    P = -40e6)
    annotation (
    Placement(visible = true, transformation(origin={-153.5,-90},  extent = {{-10, -10}, {10, 10}}, rotation = -90)));
...
equation
  ...
  annotation (
    ...
    Diagram(coordinateSystem(extent={{-165,-120},{200,120}},      grid = {0.5, 0.5})),

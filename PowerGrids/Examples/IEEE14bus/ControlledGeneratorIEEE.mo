...
equation
  connect(GOV.omegaPu, GEN.omegaPu) annotation(
    Line(points = {{-80, 26}, {-164, 26}, {-164, 64}, {32, 64}, {32, -5}, {-20, -5}}, color = {0, 0, 127}));
  connect(AVR.VcPu, GEN.VPu) annotation(
    Line(points = {{-80, -4}, {-172, -4}, {-172, 72}, {36, 72}, {36, -1}, {-20, -1}}, color = {0, 0, 127}));
  connect(AVR.efdPu, GEN.ufPuIn) annotation(
    Line(points = {{-60, -10}, {-50, -10}, {-50, 0}, {-32, 0}}, color = {0, 0, 127}));
  connect(GOV.PMechPu, GEN.PmPu) annotation(
    Line(points = {{-60, 30}, {-40, 30}, {-40, -6}, {-32, -6}}, color = {0, 0, 127}));
  ...
  connect(GEN.PPu, GOV.PPu) annotation(
    Line(points = {{-20, -3}, {-20, -2.5}, {28, -2.5}, {28, 68}, {-168, 68}, {-168, 12}, {-64, 12}, {-64, 20}}, color = {0, 0, 127}));
  connect(PmRefPuDef.y, PmRefPu.u) annotation(
    Line(points = {{-123, 42}, {-112, 42}}, color = {0, 0, 127}));

  connect(GEN.omega, omega) annotation(
    Line(points = {{-20, -7}, {-8, -7}, {-8, -20}, {10, -20}}, color = {0, 0, 127}));

...
equation
  ...
  annotation (
    ...
    Diagram(coordinateSystem(extent = {{-180, 120}, {200, -120}}, grid = {0.5, 0.5}, initialScale = 0.1), graphics={  Text(origin = {-43, -97}, lineColor = {0, 0, 255}, extent = {{-41, 7}, {41, -7}}, textString = "Load2 changed by modifiers")}),

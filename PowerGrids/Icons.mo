...
package Icons "Icons for the PowerGrids library"
  ...
  annotation(
      Icon(graphics = {Rectangle(origin = {0, 2}, fillPattern = FillPattern.Solid, extent = {{-100, 6}, {100, -10}}), Text(origin = {150, 0}, textColor = {0, 0, 255}, extent = {{-50, 10}, {50, -10}}, textString = "%name")}, coordinateSystem(initialScale = 0.1)));end Bus;
